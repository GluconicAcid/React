...
function App() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('https://images.pexels.com/photos/164636/pexels-photo-164636.jpeg?auto=compress&cs=tinysrgb&w=600')`,
      }}
    >
      <div className="w-full flex flex-wrap">
        <div className="w-1/4 md:w-1/2 h-screen bg-cover bg-center" 
          style={{
